...
function boardOfflineMessage() {
  return "Start the local board server, then open http://127.0.0.1:41737/<goal-slug>/ (or refresh this page after running: bun ~/.cursor/skills/cursor-curator/dist/cli/curator.mjs board docs/objectives/<slug>).";
}
